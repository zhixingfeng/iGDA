...
int main(int argc, const char * argv[])
{
    try{
        ...
        if (strcmp(argv[1], "test_contigs")==0){
            ...
            ValueArg<double> minlogbfArg("b","minlogbf","minimal logrithm of bayes factors, default: 20", false , 50, "minlogbf", cmd);
            ValueArg<double> maxlociArg("l","maxloci","maximal number of loci to avoid testing, default: 10", false , 10, "maxloci", cmd);
            ValueArg<double> minrrArg("r","minrr","minimal relative risk, default: 20", false , 50, "minrr", cmd);
